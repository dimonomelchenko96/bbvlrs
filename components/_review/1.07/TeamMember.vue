<template lang="pug">
	//- _r: давайте використовувати подвійни "" лапки в html, одинарні '' в js та css
	//- _r: також починайте писати першу строчку коду без табуляції
	a.team__item(:href='elem.link' @click.prevent='openContent')
		img.team__item-img(:src='elem.img')
		.team__item-title {{elem.name}}
		.team__item-position {{elem.position}}
		.team__popup(v-if='flag')
			.team__popup-close
				Close
